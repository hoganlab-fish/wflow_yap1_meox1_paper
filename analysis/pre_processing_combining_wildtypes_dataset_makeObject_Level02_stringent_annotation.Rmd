...
level_01 <- qs_read(here('output/data/Datsets/merged_wildtypes/merged_wildtypes_Level_01_stringent_annotated.qs2'))
...
Subset Level 01 to only include endothelial subsets. resolution 0.5, see ./pre_processing_combining_wildtypes_dataset_makeObject_Level01_stringent_annotation.Rmd
...
Idents(level_01) <- "RNA_snn_res.0.5"
...
level_02$L2_celltype <- case_when(
  level_02$RNA_snn_res.0.4 %in% c(2,4) ~ "VEC",
  level_02$RNA_snn_res.0.4 %in% c(5,8,9,10,12) ~ "AEC",
  level_02$RNA_snn_res.0.4 == 3 ~ "cycling_EC",
  level_02$RNA_snn_res.0.4 == 0 ~ "cycling_AEC",
  level_02$RNA_snn_res.0.4 == 1 ~ "mixed_EC",
  level_02$RNA_snn_res.0.4 == 6 ~ "Endocardium",
  level_02$RNA_snn_res.0.4 == 7 ~ "LEC",
  level_02$RNA_snn_res.0.4 == 11 ~ "pre_muLEC"
)
...
file_name <- here('output/data/Datsets/merged_wildtypes/merged_wildtypes_Level_02_stringent_annotated.qs2')
