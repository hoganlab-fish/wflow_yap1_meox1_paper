---
title: "D10051 meox1 dataset: Annotate Level 03 (LEC/VEC only) object"
...
```{r, message=FALSE, fig.align='center', fig.height=5, fig.width=12}
...
list_in <- lapply(list_objects, function(seurat) run_cluster_correlation(seurat = seurat, 
                                                                         resolutions = c("RNA_snn_res.0.1","RNA_snn_res.0.2")))
...
```{r, message=FALSE, fig.align='center', fig.width=10, fig.height=5}
...
run_dotplot(seurat = list_objects$D10051_meox1_dataset_Level_03_stringent, genes = level_03_dotplot, group = "RNA_snn_res.0.2") + ggtitle("No doublets")
```
