...
merged$L1_celltype <- case_when(
  merged$RNA_snn_res.0.4 == 8 ~ "hippo+_VEC",
  merged$RNA_snn_res.0.4 %in% c(1,9, 10) ~ "AEC",
  merged$RNA_snn_res.0.4 == 0 ~ "LEC_VEC",
  merged$RNA_snn_res.0.4 == 2 ~ "cycling_EC",
  merged$RNA_snn_res.0.4 == 3 ~ "Fibroblast",
  merged$RNA_snn_res.0.4 == 6 ~ "Endocardium",
  merged$RNA_snn_res.0.4 %in% c(4,7) ~ "Neuronal",
  merged$RNA_snn_res.0.4 %in% c(5, 14, 17) ~ "Epithelial", 
  merged$RNA_snn_res.0.4 %in% c(11,19) ~ "Hematopoietic",
  merged$RNA_snn_res.0.4 %in% c(12, 13) ~ "Chromatophore",
  merged$RNA_snn_res.0.4 == 15 ~ "Epithelium_Fibroblast",
  merged$RNA_snn_res.0.4 == 16 ~ "Immune",
  merged$RNA_snn_res.0.4 == 18 ~ "Eye_lens"
)
