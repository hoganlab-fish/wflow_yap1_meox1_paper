...
Making Level 03 object for meox1 dataset, using a more stringent filtering threshold to ditch all the low quality cells. 
...
```{r}
input_paths <- c(here('output/data/Datsets/D10051_meox1_dataset/D10051_meox1_dataset_Level_02_stringent_kept_doublets_annotated.qs2'),
                  here('output/data/Datsets/D10051_meox1_dataset/D10051_meox1_dataset_Level_02_stringent_annotated.qs2'))
...
```{r}
list_objects$D10051_meox1_dataset_Level_03_kept_doublets <- run_subset_lecvec(list_objects$D10051_meox1_dataset_Level_02_stringent_kept_doublets_annotated)
  
list_objects$D10051_meox1_dataset_Level_03 <- run_subset_lecvec(list_objects$D10051_meox1_dataset_Level_02_stringent_annotated)
```

Clean up list, remove Level 02

```{r}
list_objects$D10051_meox1_dataset_Level_02_stringent_kept_doublets_annotated <- list_objects$D10051_meox1_dataset_Level_02_stringent_annotated <- NULL
gc()
```
...
DimPlot(object = list_objects$D10051_meox1_dataset_Level_03_kept_doublets, group.by = "scDblFinder.class")
```
...
plot_list <- lapply(list_objects, function(seurat) run_dotplot(seurat, level_03_dotplot, group = "RNA_snn_res.0.2"))
...
```{r, fig.align='center', fig.height=8, fig.width=10}
plot_list <- lapply(list_objects, function(seurat) run_dotplot(seurat, level_03_dotplot, group = "RNA_snn_res.0.3"))
  wrap_plots(plot_list, ncol = 1) + plot_layout(guides = "collect", axis_titles = "collect")
```
...
file_name <- here('output/data/Datsets/D10051_meox1_dataset/D10051_meox1_dataset_Level_03_stringent.qs2')
qs_save(list_objects$D10051_meox1_dataset_Level_03, file_name)

file_name <- here('output/data/Datsets/D10051_meox1_dataset/D10051_meox1_dataset_Level_03_stringent_kept_doublets.qs2')
qs_save(list_objects$D10051_meox1_dataset_Level_03_kept_doublets , file_name)
