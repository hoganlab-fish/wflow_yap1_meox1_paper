...
################################################################################
# ---- load projects ----
path.project.yap1.level02_old <- '/hogan_lab/Hogan_Lab_Projects/yap1_project/scatacseq/Dataset_Level_02_Endothelial_cells_resubset/'
...
################################################################################
# MAKE PSEUDOBULK REPLICATES with Phenotype_Genotype_Level_02
################################################################################
project.yap1.level02 <- ArchR::addGroupCoverages(
  ArchRProj = project.yap1.level02, groupBy = "Phenotype_Genotype_Level_02", force = TRUE
)
