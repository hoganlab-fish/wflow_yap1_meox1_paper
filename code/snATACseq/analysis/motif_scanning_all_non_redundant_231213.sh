#!/bin/bash
#SBATCH --job-name="meox_enhancer_all_motif_non_redundant"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
motifOutputDir="${outputDir}/Motif_analysis/MEME/231213_meox1_enhancers_all_motifs_non_redundant_1e2"
motifFile="/team_folders/hogan_lab/Hogan_Lab_People/Oliver_Yu/motif_files/JASPAR_2024/JASPAR2024_CORE_non-redundant_pfms_meme.txt"
PvalThresh=1e-2
