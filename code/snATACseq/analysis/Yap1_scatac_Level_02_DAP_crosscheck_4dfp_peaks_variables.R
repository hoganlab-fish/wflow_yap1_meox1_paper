...
#for this we use a different archr project where peaks have been called on Phenotype_Level_02 - archr is very sensitive to grouping for peak calling
#and for marker peak analysis having marker peaks called on cell types is more logial 
...
# ---- general paths ----
save.dir <- "/hogan_lab/Hogan_Lab_Projects/yap1_project/scatacseq/Dataset_Level_02_Endothelial_cells_resubset_PeaksPhenotype/MarkerPeaks"; dir.create(save.dir, showWarnings = F)
