...
knitr::include_graphics("../output/figure_extended/embo_scores/embo_transition_scores_split_genotype_dotplot.pdf")
```
...
knitr::include_graphics("../output/figure_extended/slingshot/meox1__FeaLabel_Pseudotime_Contours_start_hmVEC_lin1.D10051.pdf")
```
