...
- `wflow_yap1_meox1_paper/docs/figure_extended/` contains the output figures (and, where the source script mixed
...
```{r, include=TRUE, fig.align="center", fig.cap=c("Example: meox1 EMBO transition score dotplot, split by genotype"), echo=FALSE}
knitr::include_graphics("../docs/figure_extended/embo_scores/embo_transition_scores_split_genotype_dotplot.pdf")
```
...
```{r, include=TRUE, fig.align="center", fig.cap=c("Example: meox1 slingshot pseudotime contours, hmVEC lineage 1"), echo=FALSE}
knitr::include_graphics("../docs/figure_extended/slingshot/meox1__FeaLabel_Pseudotime_Contours_start_hmVEC_lin1.D10051.pdf")
```
