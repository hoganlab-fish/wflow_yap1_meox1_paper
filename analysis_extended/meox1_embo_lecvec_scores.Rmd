...
DEG barplots + regenerated genesets, under `../docs/figure_extended/embo_scores/`:
...
Transition-score plots, under `../docs/figure_extended/embo_scores/`:
...
```{r class.source="fold-hide", label="embo_degbarplot", eval=TRUE, fig.height=9, fig.width=16}
all_degs <- read_csv(
    "../docs/figure_extended/dge_confects/meox1_Level_03_DEG_mutVSwt_L3_celltype_merged_VEC_merged_LEC_fc0.00_minpct_0.01.csv",
    show_col_types = F
    )
...
```{r class.source="fold-hide", label="embo_genotype_scores", eval=TRUE, fig.height=7, fig.width=5}
...
```{r class.source="fold-hide", label="embo_genotype_umaps", eval=TRUE, fig.height=5, fig.width=12}
