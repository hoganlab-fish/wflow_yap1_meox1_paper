...
**ORA input genes:** combined = 36 &nbsp;&nbsp; up = 10 &nbsp;&nbsp; down = 26 

**ORA (combined):** 315 terms &nbsp;&nbsp;  **ORA (up):** 76 terms &nbsp;&nbsp;  **ORA (down):** 266 terms

**ORA significant terms:** combined = 9 , up = 15 , down = 18 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-1.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_combined_barplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-2.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_combined_dotplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-3.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_combined_emapplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-4.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_combined_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-5.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_up_barplot.pdf` 

### ORA ( up ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-6.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_up_dotplot.pdf` 

### ORA ( up ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-7.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_up_emapplot.pdf` 

### ORA ( up ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-8.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_up_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-9.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_down_barplot.pdf` 

### ORA ( down ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-10.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_down_dotplot.pdf` 

### ORA ( down ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-11.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_down_emapplot.pdf` 

### ORA ( down ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-12.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC__pre_muLEC_ego_down_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-13.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_LECs_GO_pathways_downregulated_generatio_dotplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-14.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name, height=12, width=4)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_LECs_GO_pathways_downregulated_geneexpr_dotplot_curated.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_lec-15.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name, height=16, width=16)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_LECs_GO_pathways_downregulated_geneexpr_vlnplot_curated.pdf` 
...
**ORA input genes:** combined = 29 &nbsp;&nbsp; up = 6 &nbsp;&nbsp; down = 23 

**ORA (combined):** 292 terms &nbsp;&nbsp;  **ORA (up):** 61 terms &nbsp;&nbsp;  **ORA (down):** 253 terms

**ORA significant terms:** combined = 12 , up = 49 , down = 17 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-1.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_combined_barplot.pdf` 

### ORA ( combined ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-2.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_combined_dotplot.pdf` 

### ORA ( combined ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-3.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_combined_emapplot.pdf` 

### ORA ( combined ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-4.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_combined_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-5.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_up_barplot.pdf` 

### ORA ( up ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-6.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_up_dotplot.pdf` 

### ORA ( up ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-7.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_up_emapplot.pdf` 

### ORA ( up ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-8.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_up_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-9.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_down_barplot.pdf` 

### ORA ( down ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-10.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_down_dotplot.pdf` 

### ORA ( down ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-11.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_down_emapplot.pdf` 

### ORA ( down ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-12.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//LEC_ego_down_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-13.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_LEC_GO_pathways_downregulated_generatio_dotplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-14.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name, height=12, width=4)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_LEC_GO_pathways_downregulated_geneexpr_dotplot_curated.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_LEC-15.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name, height=16, width=16)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_LEC_GO_pathways_downregulated_geneexpr_vlnplot_curated.pdf` 
...
**ORA input genes:** combined = 1 &nbsp;&nbsp; up = 0 &nbsp;&nbsp; down = 1 

**ORA (combined):** 0 terms &nbsp;&nbsp;  **ORA (up):** 0 terms &nbsp;&nbsp;  **ORA (down):** 0 terms

**ORA significant terms:** combined = 0 , up = 0 , down = 0 

*No ORA ( combined ) terms found for pre_muLEC - skipping ORA ( combined ) plots*

*No ORA ( up ) terms found for pre_muLEC - skipping ORA ( up ) plots*

*No ORA ( down ) terms found for pre_muLEC - skipping ORA ( down ) plots*
...
**ORA input genes:** combined = 319 &nbsp;&nbsp; up = 140 &nbsp;&nbsp; down = 179 

**ORA (combined):** 1455 terms &nbsp;&nbsp;  **ORA (up):** 866 terms &nbsp;&nbsp;  **ORA (down):** 1085 terms

**ORA significant terms:** combined = 144 , up = 68 , down = 104 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-1.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_combined_barplot.pdf` 

### ORA ( combined ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-2.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_combined_dotplot.pdf` 

### ORA ( combined ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-3.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_combined_emapplot.pdf` 

### ORA ( combined ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-4.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_combined_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-5.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_up_barplot.pdf` 

### ORA ( up ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-6.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_up_dotplot.pdf` 

### ORA ( up ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-7.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_up_emapplot.pdf` 

### ORA ( up ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-8.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_up_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-9.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_down_barplot.pdf` 

### ORA ( down ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-10.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_down_dotplot.pdf` 

### ORA ( down ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-11.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_down_emapplot.pdf` 

### ORA ( down ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-12.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC__mVEC_ego_down_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-13.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_VECs_GO_pathways_downregulated_generatio_dotplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-14.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name, height=12, width=4)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_VECs_GO_pathways_downregulated_geneexpr_dotplot_curated.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/grp_vec-15.png)<!-- -->

```{.r .fold-hide}
save_plot_custom(plt, plt_name, height=16, width=16)
```

*PDF saved to:* `../output/figure_extended/go_adjpval//top15_VECs_GO_pathways_downregulated_geneexpr_vlnplot_curated.pdf` 
...
**ORA input genes:** combined = 29 &nbsp;&nbsp; up = 8 &nbsp;&nbsp; down = 21 

**ORA (combined):** 146 terms &nbsp;&nbsp;  **ORA (up):** 37 terms &nbsp;&nbsp;  **ORA (down):** 115 terms

**ORA significant terms:** combined = 0 , up = 0 , down = 3 

*No ORA ( combined ) terms found for hmVEC - skipping ORA ( combined ) plots*

*No ORA ( up ) terms found for hmVEC - skipping ORA ( up ) plots*
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_hmVEC-1.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC_ego_down_barplot.pdf` 

### ORA ( down ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/sin_hmVEC-2.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC_ego_down_dotplot.pdf` 

### ORA ( down ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/sin_hmVEC-3.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC_ego_down_emapplot.pdf` 

### ORA ( down ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/sin_hmVEC-4.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//hmVEC_ego_down_cnetplot.pdf` 
...
**ORA input genes:** combined = 112 &nbsp;&nbsp; up = 44 &nbsp;&nbsp; down = 68 

**ORA (combined):** 658 terms &nbsp;&nbsp;  **ORA (up):** 258 terms &nbsp;&nbsp;  **ORA (down):** 479 terms

**ORA significant terms:** combined = 45 , up = 39 , down = 45 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-1.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_combined_barplot.pdf` 

### ORA ( combined ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-2.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_combined_dotplot.pdf` 

### ORA ( combined ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-3.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_combined_emapplot.pdf` 

### ORA ( combined ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-4.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_combined_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-5.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_up_barplot.pdf` 

### ORA ( up ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-6.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_up_dotplot.pdf` 

### ORA ( up ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-7.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_up_emapplot.pdf` 

### ORA ( up ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-8.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_up_cnetplot.pdf` 
...
![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-9.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_down_barplot.pdf` 

### ORA ( down ): Dotplot

Adds gene ratio (fraction of input genes hitting each term) as point size, with colour  for significance - more informative than the barplot since it shows both effect size and  confidence simultaneously. **Expected:** larger, more significant dots clustering around a  coherent biological theme. **Unexpected:** significant terms with very small gene ratios  (few genes driving a 'significant' result) - treat cautiously as potentially fragile.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-10.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_down_dotplot.pdf` 

### ORA ( down ): Enrichment map

Network graph connecting GO terms that share overlapping genes - clusters of connected  terms suggest a shared underlying biological process rather than independent findings.  **Expected:** tight clusters of related terms. **Unexpected:** many isolated, unconnected  terms, suggesting the significant terms are thematically scattered rather than coherent.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-11.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_down_emapplot.pdf` 

### ORA ( down ): Category-gene network

Shows which specific genes drive which enriched terms, useful for tracing a term back to  the actual DE genes behind it. **Expected:** recognisable marker genes linking to expected  terms. **Unexpected:** a term driven entirely by one or two genes rather than a broad gene  set - weaker evidence than a term supported by many genes.

![](meox1_goanalysis_adjpval_files/figure-html/sin_mVEC-12.png)<!-- -->*PDF saved to:* `../output/figure_extended/go_adjpval//mVEC_ego_down_cnetplot.pdf` 
