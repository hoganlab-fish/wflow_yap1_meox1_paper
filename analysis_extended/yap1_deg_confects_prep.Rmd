...
```{r class.source="fold-hide", label="deg_funcs", eval=TRUE}
...
```{r class.source="fold-hide", label="deg_run", eval=TRUE}
# all celltypes
...
```{r class.source="fold-hide", label="confects_funcs", eval=TRUE}
...
```{r class.source="fold-hide", label="confects_run", eval=TRUE}
