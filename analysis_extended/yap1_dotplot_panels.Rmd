...
All under `../docs/figure_extended/dotplots/`:
...
outfile_dir <- "../docs/figure_extended/dotplots/"
...
infile_path <- "../docs/figure_extended/dge_confects/yap1_Level_03_DEG_mutVSwt_L3_celltype_merged_VEC_merged_LEC_fc0.00_minpct_0.01.csv"
