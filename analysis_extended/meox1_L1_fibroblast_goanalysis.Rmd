...
outfile_dir <- "../docs/figure_extended/go_l1_fibroblast/"
dir.create(outfile_dir, recursive = TRUE, showWarnings = FALSE)
meox_L1_fibroblasts_path <- "../docs/figure_extended/dge_confects/meox1_L1_fibroblasts_Level_01_DEG_mutVSwt_L1_celltype_fc0.00_minpct_0.01.csv"
