...
```
## Generating dataset-level composition barplots...
```

![](meox1_slingshot_pseudotime_files/figure-html/run-1.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-2.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-3.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-4.png)<!-- -->

```
## Generating per-sample unified composition barplots...
```

![](meox1_slingshot_pseudotime_files/figure-html/run-5.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-6.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-7.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-8.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-9.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-10.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-11.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-12.png)<!-- -->

```
## Processing lineage: Slingshot_Pseudotime_start_LEC_lin1 
##  Slingshot_Pseudotime_start_LEC_lin1
##  Min.   : 0.000                     
##  1st Qu.: 7.586                     
##  Median :11.187                     
##  Mean   :10.892                     
...
![](meox1_slingshot_pseudotime_files/figure-html/run-13.png)<!-- -->![](meox1_slingshot_pseudotime_files/figure-html/run-14.png)<!-- -->

```
## 
##    -> [tradeSeq] Initializing GAM fit for start: LEC lin: 1 
##       -> Fitting GAMs (this may take a few minutes)...
```
...
```
##       -> Testing Baseline Trajectory Associations...
##       -> Testing Genotype Divergence (WT vs Mut)...
##       -> Generating Smoothed Heatmaps...
```

![](meox1_slingshot_pseudotime_files/figure-html/run-15.png)<!-- -->
...
```
## Processing lineage: Slingshot_Pseudotime_start_LEC_lin2 
##  Slingshot_Pseudotime_start_LEC_lin2
##  Min.   :0.000                      
##  1st Qu.:3.226                      
##  Median :5.606                      
##  Mean   :5.465                      
...
```
## 
##    -> [tradeSeq] Initializing GAM fit for start: LEC lin: 2 
##       -> Fitting GAMs (this may take a few minutes)...
```
...
```
##       -> 23/34 requested genes (67.6%) not in fitted models object for Top 50 Genotype Divergence Genes
## (Start: LEC, Lin: 2) - dropped.
```
...
```
## Processing lineage: Slingshot_Pseudotime_start_mVEC_lin1 
##  Slingshot_Pseudotime_start_mVEC_lin1
##  Min.   : 0.000                      
##  1st Qu.: 2.503                      
##  Median : 5.305                      
##  Mean   : 6.318                      
...
```
## 
##    -> [tradeSeq] Initializing GAM fit for start: mVEC lin: 1 
##       -> Fitting GAMs (this may take a few minutes)...
```
...
```
## Generating custom 2-zone percentage plots for mVEC lineage 1...
```

```
## Processing lineage: Slingshot_Pseudotime_start_mVEC_lin2 
##  Slingshot_Pseudotime_start_mVEC_lin2
##  Min.   : 0.000                      
##  1st Qu.: 2.277                      
##  Median : 4.849                      
##  Mean   : 5.676                      
...
```
## 
##    -> [tradeSeq] Initializing GAM fit for start: mVEC lin: 2 
##       -> Fitting GAMs (this may take a few minutes)...
```
...
```
## Generating custom 2-zone percentage plots for mVEC lineage 2...
```

```
## Processing lineage: Slingshot_Pseudotime_start_pre_muLEC_lin1 
##  Slingshot_Pseudotime_start_pre_muLEC_lin1
##  Min.   : 0.00                            
##  1st Qu.: 7.01                            
##  Median :11.60                            
##  Mean   :11.03                            
...
```
## 
##    -> [tradeSeq] Initializing GAM fit for start: pre_muLEC lin: 1 
##       -> Fitting GAMs (this may take a few minutes)...
```
...
```
## Warning: All cells have the same value (1) of
## "Lineage_Weights_start_pre_muLEC_lin1"
```
...
```
## Processing lineage: Slingshot_Pseudotime_start_hmVEC_lin1 
##  Slingshot_Pseudotime_start_hmVEC_lin1
##  Min.   : 0.000                       
##  1st Qu.: 6.128                       
##  Median : 8.716                       
##  Mean   : 9.284                       
...
```
## 
##    -> [tradeSeq] Initializing GAM fit for start: hmVEC lin: 1 
##       -> Fitting GAMs (this may take a few minutes)...
```
...
```
## Warning: All cells have the same value (1) of
## "Lineage_Weights_start_hmVEC_lin1"
```
...
```
## Generating custom 3-zone percentage plots for hmVEC lineage 1...
```

```
## Generating custom zone plots for: hmVEC Lin 1 (WT Only) (Dataset: D10051)...
```

```
## Generating custom zone plots for: hmVEC Lin 1 (meox -/- Only) (Dataset: D10051)...
```
...
## 
##    -> [tradeSeq] Initializing GAM fit for start: LEC lin: 1 
##       -> Missing one genotype condition in this lineage. Skipping divergence test.
```
...
```
## Generating custom zone plots for: hmVEC Lin 1 (meox -/- Only) (Dataset: S20200)...
```
...
```
## Generating custom zone plots for: hmVEC Lin 1 (WT Only) (Dataset: S20201)...
```
...
```
## Warning: Removed 2 rows containing missing values or values outside the scale range (`geom_path()`).
...
## the data's linetype values.
```

```
## Warning: No shared levels found between `names(values)` of the manual scale and the data's linetype values.
## No shared levels found between `names(values)` of the manual scale and the data's linetype values.
## No shared levels found between `names(values)` of the manual scale and the data's linetype values.
```
...
```
## Warning in max(zones_only_summary$Cell_Count, na.rm = TRUE): no non-missing
...
```
## Warning in max(zones_only_summary$Proportion, na.rm = TRUE): no non-missing
## arguments to max; returning -Inf
```
...
```
## Warning in max(dataset_zones_only$Cell_Count, na.rm = TRUE): no non-missing
## arguments to max; returning -Inf
```
