#!/usr/bin/Rscript
# Addition of cdkn1a, tp53 and cdkn1bb genes to meox1_dataset_Level_03_L3_celltype_genotype_cellcyclelec
library(ggplot2)
library(Seurat)
library(qs2)

infile_path <- "../../Saki_data/paper/D10051_meox1_dataset_Level_03_annotated.qs2"
outfile_path <- "../Revision_analysis/queue_plots/meox1_dataset_Level_03_L3_celltype_genotype_cellcyclelec_cdkn1a_tp53_cdkn1bb.pdf"
